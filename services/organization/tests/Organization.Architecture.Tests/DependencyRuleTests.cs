...
/// conforme design §3 do módulo organization.
///
...
public sealed class DependencyRuleTests
{
    ...
    /// Mapeia: design §3, design §2 (princípio 1 — Clean Architecture).
    /// </summary>
    ...
    ///
    /// Domain não deve conhecer EF Core, Redis, GCP SDKs ou qualquer adapter.
    /// Mapeia: design §3, design §2 (princípio 1 — Domain independente de infraestrutura).
    /// </summary>
    ...
    /// Mapeia: design §3, design §2 (princípio 1).
    /// </summary>
    ...
    /// Mapeia: design §2 (princípio 1), design §3.
    /// </summary>
